...
export const metadata: Metadata = {
  title: 'À propos',
  description: 'Agence.liaison sélectionne et gère des chalets et villas d’exception en France.',
};
        ...
        <div className="container-app relative">
          <FadeIn>
            ...
            <p className="mt-4 max-w-xl text-sand-200">
              Agence.liaison accompagne voyageurs et locataires dans la découverte, la visite et la
        ...
        <div className="container-app max-w-3xl">
          <FadeIn>
            ...
            <p className="mt-4 leading-relaxed text-ink-500">
              Agence.liaison réunit sur une même plateforme des annonces vérifiées, un processus de visite
