...
export const metadata: Metadata = {
  ...
  description: 'Découvrez les étapes pour trouver, visiter et réserver votre chalet ou villa avec Agence.liaison.',
};
    ...
    <div className="container-app py-14 sm:py-20">
      <FadeIn>
        <SectionHeading
          ...
          title="Comment ça marche"
          description="De la première recherche à la remise des clés, voici comment se déroule votre parcours avec Agence.liaison."
        />
      </FadeIn>
