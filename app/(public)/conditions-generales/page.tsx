...
export default function ConditionsGeneralesPage() {
  return (
    <LegalPage title="Conditions générales d’utilisation" updatedAt="21 août 2026">
      <h2>Objet</h2>
      <p>
        Les présentes conditions générales régissent l’utilisation du site Agence.liaison et les
      ...
      <p>
        ...
        demandé reste soumis à confirmation par Agence.liaison, qui contacte le client pour
      ...
      <p>
        ...
        aucun paiement sur le site. Agence.liaison examine le dossier, communique sa décision et
      ...
      <p>
        Agence.liaison agit en tant qu’intermédiaire entre locataires et propriétaires ou
