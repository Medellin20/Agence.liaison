...
export default function MentionsLegalesPage() {
  return (
    <LegalPage title="Mentions légales" updatedAt="9 août 2026">
      ...
      <p>
        Le site Agence.liaison est édité par Agence.liaison SAS, société à responsabilité simplifiée de droit français. <em>[Ces informations sont fournies à titre d’exemple et doivent être
      ...
      <p>
        Agence.liaison s’efforce d’assurer l’exactitude des informations diffusées sur ce site mais
