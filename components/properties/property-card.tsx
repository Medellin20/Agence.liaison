...
export function PropertyCard({ property }: { property: PropertyWithRelations }) {
  ...
  return (
    <article className="group relative flex h-full flex-col rounded-xl border border-ink-100/70 bg-white p-0 shadow-soft transition-shadow duration-300 hover:shadow-lifted">
      <div className="relative aspect-[4/3] overflow-hidden rounded-t-xl bg-sand-200">
        {primaryImage ? (
          <Image
